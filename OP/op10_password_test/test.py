...
def test__is_different__new_pass_odd_length__barely_different__reverse():
    """The one with the coffee at noon."""
    assert is_different_from_old_password("1Pasxxxxx", "yyyyysaP1") is True


def test__is_different__new_pass_odd_length__barely_not_different():
    """The one with the coffee at noon."""
    assert is_different_from_old_password("1Passyyyy", "1Passxxxx") is False


def test__is_different__new_pass_odd_length__barely_not_different__not_in_beginning():
    """The one with the coffee at noon."""
    assert is_different_from_old_password("zz1Passyyyy", "zz1Passxxxx") is False


def test__is_different__new_pass_odd_length__barely_not_different__not_in_beginning_reverse():
    """The one with the coffee at noon."""
    assert is_different_from_old_password("zzzzyyyyy", "xxxxyyyyy") is False
...
def test__is_different__new_pass_even_length__barely_different():
    """The one with the coffee at noon."""
    assert is_different_from_old_password("Password", "Pasxxxxx") is True


def test__is_different__new_pass_even_length__barely_different__reverse():
    """The one with the coffee at noon."""
    assert is_different_from_old_password("Password", "xxxxxsaP") is True


def test__is_different__new_pass_even_length__barely_not_different():
    """The one with the coffee at noon."""
    assert is_different_from_old_password("Paswyyyy", "Paswxxx") is False
...
if __name__ == '__main__':
    ...
    test__is_different__new_pass_odd_length__barely_not_different__not_in_beginning_reverse2()
