...
if __name__ == "__main__":
    ...
    print("Regs 1", spaceship.get_regular_crewmates())
    ...
    print("Regs 2", spaceship.get_regular_crewmates())
    print("kill imp Red")
    ...
    print("Regs 3", spaceship.get_regular_crewmates())
